...
func TestGetOverlaysForView(t *testing.T) {
	...
	// Register overlays
	manager.RegisterOverlay(info1, overlay1)
	manager.RegisterOverlay(info2, overlay2)
...
func TestTriggerUpdate(t *testing.T) {
	...
	manager.RegisterOverlay(info, overlay)
...
func TestGetOverlayByID(t *testing.T) {
	...
	manager.RegisterOverlay(info, testOverlay)
